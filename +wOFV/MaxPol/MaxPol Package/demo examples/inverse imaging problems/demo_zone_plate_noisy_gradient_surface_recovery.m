...
h_centralized_l1_recovery = figure('rend','painters','pos',[50, 50, 400, 400]);
...
%
h_centralized_l1_residual_error = figure('rend','painters','pos',[50, 550, 400, 400]);
...
%  prepare for image excution
h_centralized_l5_recovery = figure('rend','painters','pos',[450, 50, 400, 400]);
imagesc(X, [min(f_0(:)), max(f_0(:))])
axis image
colormap('gray')
set(gca, 'Xtick', [], 'Ytick', [])
...
%
h_centralized_l5_residual_error = figure('rend','painters','pos',[450, 550, 400, 400]);
imagesc(abs(res_frame)*error_magnification, [0, max(f_0(:))-min(f_0(:))])
axis image
colormap(selected_colormap)
set(gca, 'Xtick', [], 'Ytick', [])
...
%  prepare for image excution
h_staggered_l1_recovery = figure('rend','painters','pos',[850, 50, 400, 400]);
imagesc(X, [min(f_0(:)), max(f_0(:))])
axis image
colormap('gray')
set(gca, 'Xtick', [], 'Ytick', [])
...
%
h_staggered_l1_residual_error = figure('rend','painters','pos',[850, 550, 400, 400]);
imagesc(abs(res_frame)*error_magnification, [0, max(f_0(:))-min(f_0(:))])
axis image
colormap(selected_colormap)
set(gca, 'Xtick', [], 'Ytick', [])
...
%  prepare for image excution
h_staggered_l5_recovery = figure('rend','painters','pos',[1250, 50, 400, 400]);
imagesc(X, [min(f_0(:)), max(f_0(:))])
axis image
colormap('gray')
set(gca, 'Xtick', [], 'Ytick', [])
...
%
h_staggered_l5_residual_error = figure('rend','painters','pos',[1250, 550, 400, 400]);
imagesc(abs(res_frame)*error_magnification, [0, max(f_0(:))-min(f_0(:))])
axis image
colormap(selected_colormap)
set(gca, 'Xtick', [], 'Ytick', [])
