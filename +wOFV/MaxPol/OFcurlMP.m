function crl=OFcurlMP(V,lD,PD,lS,PS)
%Compute the vorticity (curl) of a velocity field V using MaxPol 
...
%McManus in his PhD thesis (McManus, 2019). The output is crl, a matrix 
%of the same size as u and v containing the curl.
...
crl=Dx*V(:,:,2)*Sx-Sy*V(:,:,1)*Dy;

%Truncate added boundary points
crl=crl(5:end-4,5:end-4);